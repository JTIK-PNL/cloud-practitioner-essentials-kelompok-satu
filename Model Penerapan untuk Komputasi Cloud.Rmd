---
title: "Model Penerapan untuk Komputasi Cloud"
date: " april 25, 2024"
output:
...
Tiga model penerapan komputasi awan adalah cloud-based, on-premises (lokal), dan hybrid. Mari kita uraikan masing-masing model tersebut:
...
If you've tried to do it the right way and still really want to break these rules, email me at [joe\@rstudio.com](mailto:joe@rstudio.com){.email} and let's talk about it. But please, do that before sinking weeks or months into your app, while I can still help you!
:::
...
::: notes
Don't worry, there won't be a quiz on this. All of this is to point the way towards the two things you *do* need to remember.
